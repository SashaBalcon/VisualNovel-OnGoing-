...
from .c3c12c12 import C3C12C1, C3C12C2
...
class Choice3_12_12(Template):
    ...
    def RecMain(self):
        ...
        #choice1
        self.choice1 = self.choice_font.render('Are you here for the marine biology internship?', True, self.white)

        #square surrounding choice1
        self.choice1_rect = pygame.Rect(0, 0, 550, 32)
        ...
        #choice2
        self.choice2 = self.choice_font.render("The interview room's down the hall", True, self.white)
