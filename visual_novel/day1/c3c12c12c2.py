...
from .c3c12c12c12choice12 import Choice3_12_12_12_12
...
class C3C12C12C2(Template):
    ...
    def text1(self):
        text = "(You think you can divert your attention away a little bit from your own task; she is a friend after all. As you approach her, she is noticeably focused. As you tap her on the shoulder, she seems to startle.)"
    ...
    def text2(self):
        text = "Sammy: Wha- God! Wow, I didn't notice you."
    ...
    def text3(self):
        text = "You: Oh, sorry about that. I just saw you across from where I was and decided to say 'hi.'"
    ...
    def text5(self):
        text = "(She shifts her gaze from you and starts restocking again.)"
    ...
    def text6(self):
        text = "You: …I was wondering if you wanted to hang out for a bit?"
    ...
    def text7(self):
        text = "Sammy: Huh? Oh, yeah, I literally can't right now. I've been assigned a ton for like, no reason, and my supervisor expects me to get it all done by the end of the day."
    ...
    def text8(self):
        text = "You: Ugh, tell me about it. Just last week they made me catalogue the materials in every single lab we’ve got here. It was a nightmare."
    ...
    def text9(self):
        text = "Sammy: This job kinda- no, REALLY sucks sometimes. Do you even like working here?"
            ...
            if self.available:
                ...
                if text_pressed:
                    if self.text_idx < len(self.text_funcs):
                        ...
                        Choice3_12_12_12_12(self.screen)
                        running = False
                    text_pressed = False
