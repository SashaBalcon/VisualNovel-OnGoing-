...
from .c3c12c12c1 import C3C12C12C1
from .c3c12c12c2 import C3C12C12C2
...
class Choice3_12_12_12(Template):
    ...
    def RecMain(self):
        ...
        #choice1
        self.choice1 = self.choice_font.render('Approach her', True, self.white)
        ...
        #choice2
        self.choice2 = self.choice_font.render("Keep focused on your own task.", True, self.white)
