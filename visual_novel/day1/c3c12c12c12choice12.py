...
from .c3c12c12c12c12c1 import C3C12C12C12C12C1
...
class Choice3_12_12_12_12(Template):
    ...
    def RecMain(self):
        ...
        #choice1
        self.choice1 = self.choice_font.render('Yeah, I do.', True, self.white)
        ...
        #choice2
        self.choice2 = self.choice_font.render("No, not really.", True, self.white)
