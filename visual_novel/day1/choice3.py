...
class Choice3_1(Template):
    ...
    def RecMain(self):
        ...
        #choice1
        self.choice1 = self.choice_font.render('Yeah yeah, enjoy your shift too.', True, self.white)
        ...
        #choice2
        self.choice2 = self.choice_font.render('What are you laughing at me for? ', True, self.white)
